<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="MaterialTransfrLocOutSidePrint.aspx.cs" Inherits="Reports_MaterialTransfrLoc" Title="Material TransferLocation Print" %>
...
<h2>Material Transfer Outside Details</h2></td>
</tr>
<tr>
<td colspan="5"  align="center" class="SubTitle">
    &nbsp;</td>
          ...
          <Columns>
           ...
           <asp:BoundField DataField="TransFrom" HeaderText="Transfer From">
                ...
                <ItemStyle Wrap="false" HorizontalAlign="Right"/>
                  ...
                  <FooterStyle ForeColor="White" HorizontalAlign="Right" Wrap="False" />
