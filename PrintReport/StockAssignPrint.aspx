<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="StockAssignPrint.aspx.cs" Inherits="Reports_MaterialReqTemplatePrint" Title="Stock Assign Report" %>
...
<h2>ISSUSE DETAILS</h2></td>
</tr>

<tr>
<td class="Label_Dynamic" align="left" colspan="2" >Issuse No :&nbsp;
...
<tr>
<td class="Label_Dynamic" align="left" colspan="2" >Reference No :&nbsp;
...
<asp:BoundField DataField="Outward" HeaderText="Outward Quantity" >
...
<asp:BoundField DataField="Location" HeaderText="To Location" >
<HeaderStyle Wrap="False" HorizontalAlign="Center"/>
<ItemStyle Wrap="False" HorizontalAlign="Left" />
</asp:BoundField>
</Columns>
...
<td></td>
<td class="Label1" width="30%">Issued By</td>
<td></td>
