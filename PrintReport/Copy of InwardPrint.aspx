<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="Copy of InwardPrint.aspx.cs" Inherits="Reports_PurchaseOrderPrint" Title="Inward Register Report" %>
             ...
             <tr>
                   <td colspan="7">
                       <table width="100%">
                           ...
                           <tr><td colspan="3"></td></tr>
                           <tr>
                           <td colspan="3" align="left" class="Label_Dynamic">
                               Instruction:
                           ...
                           <tr>
                           <td></td>
                            <td class="Label_Dynamic" align="right" style="width: 553px">
                                Subtotal:</td>
                            <td height="20px" colspan="1" align="right">
                           ...
                           <td></td>
                            <td class="Label_Dynamic" align="right" style="width: 553px" >
                                Packing :</td>
                            <td height="10px" colspan="1" align="right">
