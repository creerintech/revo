...
public partial class Reports_MaterialTransfrLoc : System.Web.UI.Page
{
    #region[Variables]
    ...
    {
        string fileName = "MaterialTranfrLocatnOutside.pdf";
    ...
    public void GeneratePDFNew(string Imagepath, string fileName, string HeaderName, GridView GridReport, Page oPage, string text)
    {
        ...
        try
        {
            ...
            str = str + "<br><tr><td colspan='5'><table Width='100%'><tr><td width='15%'>Prepared By</td><td></td><td width='15%'>Received By</td><td></td><td width='15%'>Authorised By</td></tr></br>";
