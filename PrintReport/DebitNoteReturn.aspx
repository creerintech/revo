<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="DebitNoteReturn.aspx.cs" Inherits="Reports_DebitNote" Title="Debit Note" %>
...
<table width="100%" align="center" >
            ...
            <td>
                <asp:Label ID="lblDebitNoteNo" runat="server" CssClass="BoldText" 
                    Text=""></asp:Label>
                <br />
                <asp:Label ID="lblDate" runat="server" CssClass="BoldText" Text=""></asp:Label>
                <br />
            ...
            <tr>
                <td  class="Label_Dynamic" align="right" style="width: 151px" >To,</td>
                <td>
                    &nbsp;</td>
                <td >
                    &nbsp;</td>
            ...
            <tr><%-- class="BoldText">--%>
                <td  class="Label_Dynamic" align="right" style="width: 151px" >Vendor Name:<%-- class="BoldText">--%>
                </td>
                <td colspan="2">
            ...
            <tr>
         <td class="Label_Dynamic" align="right" style="width: 151px">
             Address :</td>
         <td colspan="2">
         ...
         <td class="Label_Dynamic" align="right" style="width: 151px">
             Date :</td>
        <td>
        <asp:Label ID="lblSysDate" CssClass="Label_Dynamic" runat="server" ></asp:Label>
        </td>
        <td class="Label_Dynamic" align="right">Time :</td>
        <td>
        <asp:Label ID="lblSysTime" CssClass="Label_Dynamic" runat="server" ></asp:Label></td>
         </tr>
            <tr>
         <td class="Label_Dynamic" align="right" style="width: 151px">
             &nbsp;</td>
                   ...
                   <td colspan="4">
                       <table width="100%">
                         ...
                         <asp:GridView ID="PurOrderGrid" runat="server" 
                          ...
                          Net Amount : <asp:Label runat="server" ID="LblNetAmt" ></asp:Label></td>
                           </tr>
                           <tr>
                           <td class="Label_Dynamic" align="left">
                               &nbsp;</td>
...
<tr>
<td class="Label2" width="30%">Prepared By</td>
<td></td>
<td class="Label2" width="30%">Accepted By</td>
<td></td>
<td class="Label2" width="30%">Authorised By</td>
</tr>
<tr>
<td class="Label">&nbsp;</td>
<td>&nbsp;</td>
