...
{
    public class servicepo : Utility.Setting
    {
        ...
        public int UpdateRecord(ref PurchaseOrder Entity_Call, out string strError)
        {
            ...
            try
            {
                ...
                iInsert = SQLHelper.ExecuteNonQuery(_Connection, _Transaction, CommandType.StoredProcedure, PurchaseOrder.SP_PurchaseOrderservicepo, Param);
        ...
        public DataSet GetPOForEdit(int ID, out string strError)
        {
            ...
            try
            {
                ...
                Open(CONNECTION_STRING);
                Ds = SQLHelper.GetDataSetDoubleParm(_Connection, _Transaction, CommandType.StoredProcedure, PurchaseOrder.SP_PurchaseOrderservicepo, pAction, pPOId);
        ...
        public int Insert_PurchseOrder(ref PurchaseOrder Entity_Call, String NO, out string strError)
        {
            ...
            try
            {
                ...
                iInsert = SQLHelper.ExecuteScalar(_Connection, _Transaction, CommandType.StoredProcedure, PurchaseOrder.SP_PurchaseOrderservicepo, Param);
        ...
        public int Delete_PurchaseOrder(ref PurchaseOrder Entity_Call, out string strError)
        {
            ...
            try
            {
                ...
                iDelete = SQLHelper.ExecuteNonQuery(_Connection, _Transaction, CommandType.StoredProcedure, PurchaseOrder.SP_PurchaseOrderservicepo, Param);
        ...
        public DataSet GetPurchase_Order(string RepCondition, out string strError)
        {
            ...
            try
            {
                ...
                Open(CONNECTION_STRING);
                Ds = SQLHelper.GetDataSetDoubleParm(_Connection, _Transaction, CommandType.StoredProcedure, PurchaseOrder.SP_PurchaseOrderservicepo, pAction, pRepCondition);
