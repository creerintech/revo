...
{
    public class DMPurchaseOrder : Utility.Setting
    {
        ...
        public int UpdateRecord(ref PurchaseOrder Entity_Call, out string strError)
        {
            ...
            try
            {
                ...
                pInstallationSerTaxPer,pInstallationSerTaxAmt,pCGSTTotAmt,pSGSTTotalAmt,pIGSTTotalAmt};
        ...
        public int Insert_PurchaseOrderDtls(ref PurchaseOrder Entity_Call,int ID, out string strError)
        {
            ...
            try
            {
                ...
                // SqlParameter phsncode = new SqlParameter(PurchaseOrder._hsncode, SqlDbType.Decimal);
