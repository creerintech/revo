...
public class PurchaseOrder
{
    ...
    public static string _natureofproccesing = "@natureofproccesing";

    public const string _GSTPer = "@GSTPer";
        public const string _GSTAmt = "@GSTAmt";
        public const string _CGSTTotAmt = "@CGSTTotAmt";
        public const string _SGSTTotalAmt = "@SGSTTotalAmt";
        public const string _IGSTTotalAmt = "@IGSTTotalAmt";
        public const string _CGSTAmt = "@CGSTAmt";
        public const string _SGSTAmt = "@SGSTAmt";
        public const string _IGSTAmt = "@IGSTAmt";
        public const string _GSTPerDetails = "@GSTPerDetails";
        public const string _CGSTPer = "@CGSTPer";
        public const string _SGSTPer = "@SGSTPer";
        public const string _IGSTPer = "@IGSTPer";  
    ...
    #region[Definations]
        ...
        public decimal CGSTTotAmt { get; set; }
    ...
    private String m_natureofproccesing;
    public String natureofproccesing
    {
        get { return m_natureofproccesing; }
        set { m_natureofproccesing = value; }
    }
    ...
    #region[Store Procedures]
        ...
        public static string SP_PurchaseOrder_Report = "SP_PurchaseOrder_Report";
        public static string SP_PurchaseOrderservicepo = "SP_PurchaseOrderservicepo";

    public static string SP_PurchaseOrderjobworkout = "SP_PurchaseOrderjobworkout";
    #endregion
