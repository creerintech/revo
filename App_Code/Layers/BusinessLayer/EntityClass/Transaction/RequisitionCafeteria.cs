...
/// <summary>
/// Summary description for RequisitionCafeteria
/// </summary>
public class RequisitionCafeteria
{
    #region[Constants]
    ...
    public static string _avlstock= "@avlstock";
    public static string _balstock= "@balstock";
    public static string _unit= "@unit";
   
    public static string _RequiredDate= "@RequiredDate";
    #endregion
    ...
    private String m_balstock;

    public String balstock
    {
        get { return m_balstock; }
        set { m_balstock = value; }
    }



    private String m_avlstock;

    public String avlstock
    {
        get { return m_avlstock; }
        set { m_avlstock = value; }
    }
    ...
    #region[procedure]
      public static string SP_RequisitionCafeteria = "SP_RequisitionCafeteria";
      public static string SP_RequisitionCafeteriaTemplate = "SP_RequisitionCafeteriaTemplate";//For New Template Requisition
      public static string SP_RequisitionCafeteriaReport = "SP_RequisitionCafeteriaReport";
      public static string SP_RequisitionCafeteriaReport1 = "SP_RequisitionCafeteriaReport1";
    #endregion
    public RequisitionCafeteria()
	{
		//
