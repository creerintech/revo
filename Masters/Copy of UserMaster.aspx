<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage_RN.master" AutoEventWireup="true" CodeFile="Copy of UserMaster.aspx.cs" Inherits="Masters_UserMaster" Title="User Master" %>
...
<td class="Label">Edit Authorised Purchase Order :</td>
<td class="Label">&nbsp; </td>
<td align="left">
<asp:CheckBox runat="server" ID="CHKYESEDITPO" Text="&nbsp;&nbsp;View/Edit"  onclick="javascript:EnableTextBox();"/>
</td>
<td>
...
<td class="Label">&nbsp; </td>
<td align="left">
<asp:CheckBox runat="server" ID="CHKESCESSREPORT" Text="&nbsp;&nbsp;View/Edit"  onclick="javascript:EXCESSEnableTextBox();"/>
</td>
<td>
