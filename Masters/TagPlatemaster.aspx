<%@ Page Title="Tag Plate Master" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="TagPlatemaster.aspx.cs" Inherits="Masters_TagPlatemaster" %>
                                        ...
                                        <div id="DivDisp" runat="server" class="ScrollableDiv_FixHeightWidth4" width="90%">
                                             ...
                                             <asp:GridView ID="grdwoodenbox" runat="server" CssClass="mGrid" AutoGenerateColumns="false" ShowFooter="true">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Tag Size ">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtwoodenbox" runat="server" Text='<%# Eval("WoodenBoxSize") %>' CssClass="TextBox"></asp:TextBox>
