<%@ Page Title="Schedule" Language="C#" MasterPageFile="~/MasterPages/MasterPage_RN.master" AutoEventWireup="true" CodeFile="Shcedule.aspx.cs" Inherits="Masters_Shcedule" %>
...
<ContentTemplate>
 ...
 <table width="100%" cellspacing="6">
        ...
        <tr>
            ...
            <td align="left">
            <asp:TextBox ID="txtSchedules" runat="server" CssClass="TextBox"
            ...
            ControlToValidate="txtSchedules" Display="None"
            ErrorMessage="Schedule Type  Required" SetFocusOnError="True"
            ValidationGroup="Add">
