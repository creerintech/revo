...
public partial class Masters_ItemSize : System.Web.UI.Page
{
    #region[Private Variables]
    DMItemSizeMaster Obj_ItemCategory = new DMItemSizeMaster();
    ItemSizeMaster Entity_ItemCategory = new ItemSizeMaster();
        ...
        try
        {
            ...
            if (Session["UserName"] != null && Session["UserRole"] != null)
            {
                ...
                //{
                    ...
                    DataRow[] dtRow = dsChkUserRight1.Tables[1].Select("FormName ='Item Size Master'");
                    if (dtRow.Length > 0)
                    {
