...
public partial class Masters_UserMaster : System.Web.UI.Page
{
        ...
        try
        {
            if (CHECKVALIDATION() == true)
            {
                ...
                else
                {
                    ...
                    Entity_UserMaster.mob = txtmob.Text;
                    ...
                    if (InsertRow != 0)
                    {
                        ...
                        {
                            InsertChkDetail = Obj_UserMaster.InsertUserPermissionForEditPO(ID, "Purchase Order Shortage/Excess Report", 1, TXTEXCESSREPORT.Text.Trim(), out StrError);
                        }
                        if (CHKYESEDITPO.Checked == false)
                        {
                            InsertChkDetail = Obj_UserMaster.InsertUserPermissionForEditPO(ID, "Edit Authorised Purchase Order", 0, TXTPASSEDITPO.Text.Trim(), out StrError);
                        }
                        if (CHKYESUNITCONVERSION.Checked == false)
                        {
                            InsertChkDetail = Obj_UserMaster.InsertUserPermissionForEditPO(ID, "Unit Conversion In Item Master", 0, TXTPASSEDITPO.Text.Trim(), out StrError);
                        }
                        if (CHKESCESSREPORT.Checked == false)
                        {
                            InsertChkDetail = Obj_UserMaster.InsertUserPermissionForEditPO(ID, "Purchase Order Shortage/Excess Report", 0, TXTEXCESSREPORT.Text.Trim(), out StrError);
                        }
                        #endregion---------------------------
                        if (InsertRow != 0)
                        {
        ...
        try
        {
          ...
          //  Entity_UserMaster.CafeteriaId = Convert.ToInt32(DDLCafe.SelectedValue);
            ...
            if (UpdateRow != 0)
            {
                ...
                if (CHKYESEDITPO.Checked == false)
                {
                    InsertChkDetail = Obj_UserMaster.InsertUserPermissionForEditPO(Convert.ToInt32(ViewState["EditID"]), "Edit Authorised Purchase Order", 0, TXTPASSEDITPO.Text.Trim(), out StrError);
                }
                if (CHKYESUNITCONVERSION.Checked == false)
                {
                    InsertChkDetail = Obj_UserMaster.InsertUserPermissionForEditPO(Convert.ToInt32(ViewState["EditID"]), "Unit Conversion In Item Master", 0, TXTPASSEDITPO.Text.Trim(), out StrError);
                }
                if (CHKESCESSREPORT.Checked == false)
                {
                    InsertChkDetail = Obj_UserMaster.InsertUserPermissionForEditPO(Convert.ToInt32(ViewState["EditID"]), "Purchase Order Shortage/Excess Report", 0, TXTEXCESSREPORT.Text.Trim(), out StrError);
                }
                #endregion---------------------------
                if (UpdateRow != 0)
                {
                           ...
                           txtmob.Text= DS.Tables[0].Rows[0]["mob"].ToString();
                            ...
                            if (DS.Tables[4].Rows.Count > 0)
                            {
                                for (int k = 0; k < DS.Tables[4].Rows.Count; k++)
                                {
                                    ...
                                    {
                                        CHKYESEDITPO.Checked = Convert.ToBoolean(Convert.ToInt32(DS.Tables[4].Rows[k]["Permission"].ToString()));
                                        TXTPASSEDITPO.Text = DS.Tables[4].Rows[k]["Password"].ToString();
                                        TXTPASSEDITPO.Attributes["value"] = DS.Tables[4].Rows[k]["Password"].ToString();
                                    }
                                    if (DS.Tables[4].Rows[k]["Form"].ToString() == "Unit Conversion In Item Master")
                                    {
                                        CHKYESUNITCONVERSION.Checked = Convert.ToBoolean(Convert.ToInt32(DS.Tables[4].Rows[k]["Permission"].ToString()));
                                    }
                                    if (DS.Tables[4].Rows[k]["Form"].ToString() == "Purchase Order Shortage/Excess Report")
                                    {
                                        CHKESCESSREPORT.Checked = Convert.ToBoolean(Convert.ToInt32(DS.Tables[4].Rows[k]["Permission"].ToString())); 
                                        TXTEXCESSREPORT.Text = DS.Tables[4].Rows[k]["Password"].ToString();
                                        TXTEXCESSREPORT.Attributes["value"] = DS.Tables[4].Rows[k]["Password"].ToString();
                                    }
                                }
                            }
                            else
    ...
    protected void GrdViewRight_CheckedChanged(object sender, EventArgs e)
    {
        ...
        GridUserRight.Rows[dr.RowIndex].FindControl("GrdViewRight").Focus();
    }
    ...
    protected void RadioIsAdmin_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        try
        {
            if (RadioIsAdmin.Items[0].Selected)
            {
                ...
                ((CheckBox)GridUserRight.HeaderRow.FindControl("GrdAllAddRight")).Checked = true;
                ((CheckBox)GridUserRight.HeaderRow.FindControl("GrdAllViewRight")).Checked = true;
                ((CheckBox)GridUserRight.HeaderRow.FindControl("GrdAllEditRight")).Checked = true;
                ((CheckBox)GridUserRight.HeaderRow.FindControl("GrdAllDelRight")).Checked = true;
                ((CheckBox)GridUserRight.HeaderRow.FindControl("GrdAllPrintRight")).Checked = true;
                for (int i = 0; i < GridUserRight.Rows.Count; i++)
                {
            ...
            else
            {
                ...
                ((CheckBox)GridUserRight.HeaderRow.FindControl("GrdAllAddRight")).Checked = false;
                ((CheckBox)GridUserRight.HeaderRow.FindControl("GrdAllViewRight")).Checked = false;
                ((CheckBox)GridUserRight.HeaderRow.FindControl("GrdAllEditRight")).Checked = false;
                ((CheckBox)GridUserRight.HeaderRow.FindControl("GrdAllDelRight")).Checked = false;
                ((CheckBox)GridUserRight.HeaderRow.FindControl("GrdAllPrintRight")).Checked = false;
                for (int i = 0; i < GridUserRight.Rows.Count; i++)
                {
   ...
   protected void GridUserRight_RowDataBound(object sender, GridViewRowEventArgs e)
    ...
    protected void GrdAllAddRight_CheckedChanged(object sender, EventArgs e)
    {
        CheckBox GrdSelectAllHeader = ((CheckBox)GridUserRight.HeaderRow.FindControl("GrdAllAddRight"));
        if (GrdSelectAllHeader.Checked == true)
        {
            for (int i = 0; i < GridUserRight.Rows.Count; i++)
            {
    ...
    protected void GrdAllViewRight_CheckedChanged(object sender, EventArgs e)
    {
        CheckBox GrdSelectAllHeader = ((CheckBox)GridUserRight.HeaderRow.FindControl("GrdAllViewRight"));
        if (GrdSelectAllHeader.Checked == true)
        {
            for (int i = 0; i < GridUserRight.Rows.Count; i++)
            {
    ...
    protected void GrdAllEditRight_CheckedChanged(object sender, EventArgs e)
    {
        CheckBox GrdSelectAllHeader = ((CheckBox)GridUserRight.HeaderRow.FindControl("GrdAllEditRight"));
        if (GrdSelectAllHeader.Checked == true)
        {
            for (int i = 0; i < GridUserRight.Rows.Count; i++)
            {
    ...
    protected void GrdAllDelRight_CheckedChanged(object sender, EventArgs e)
    {
        CheckBox GrdSelectAllHeader = ((CheckBox)GridUserRight.HeaderRow.FindControl("GrdAllDelRight"));
        if (GrdSelectAllHeader.Checked == true)
        {
            for (int i = 0; i < GridUserRight.Rows.Count; i++)
            {
    ...
    protected void GrdAllPrintRight_CheckedChanged(object sender, EventArgs e)
    {
        CheckBox GrdSelectAllHeader = ((CheckBox)GridUserRight.HeaderRow.FindControl("GrdAllPrintRight"));
        if (GrdSelectAllHeader.Checked == true)
        {
            for (int i = 0; i < GridUserRight.Rows.Count; i++)
            {
