...
public partial class Masters_Non_stditemshardware : System.Web.UI.Page
{
    ...
    {
        ReportGrid.DataSource = db.Displaygrid("select distinct 0 as # , itemname as TemplateName ,0 as title from nonstnonstdhardware");
        ReportGrid.DataBind();
    }
    ...
    protected void BtnSave_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < grdwoodenbox.Rows.Count; i++)
        {
            try
            {
                ...
                db.insert("Insert Into nonstnonstdhardware values('" + "0" + "' ,'" + itemname + "' ,'" + txtwoood + "' )");
                bindreport();
            }
            catch (Exception ex)
            {
    ...
    protected void BtnUpdate_Click(object sender, EventArgs e)
    {
        ...
        db.insert("delete nonstnonstdhardware  ");
                ...
                case ("Select"):
                    {
                        ...
                        grdwoodenbox.DataSource = db.Displaygrid("select   itemname  , WoodenBoxSize  from nonstnonstdhardware where iterlockid='" + 0 + "'");

                        grdwoodenbox.DataBind();

                        ViewState["CurrentTablewood"] = db.Displaygrid("select id as RowNumber,  itemname  , WoodenBoxSize from nonstnonstdhardware where iterlockid='" + 0 + "'");
                        DataTable dtwood = new DataTable();
                        dtwood = db.Displaygrid("select *  from nonstnonstdhardware where iterlockid='" + ViewState["EditID"] + "'");
                ...
                case ("Delete"):
                    {
                        ...
                        db.insert("delete nonstnonstdhardware where  iterlockid='" + ViewState["EditID"] + "' ");
