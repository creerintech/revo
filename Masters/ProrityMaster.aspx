<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage_RN.master" AutoEventWireup="true" CodeFile="ProrityMaster.aspx.cs" Inherits="Masters_ProrityMaster" Title="Priority" %>
 ...
 <table width="100%" cellspacing="6">
       <tr>
        ...
        <tr>
            ...
            <td align="left">
            <asp:TextBox ID="Priority" runat="server" CssClass="TextBox"
            MaxLength="50" Width="350px" ></asp:TextBox>
            </td>
            
            <td>
            <asp:RequiredFieldValidator ID="Req1" runat="server"
            ControlToValidate="Priority" Display="None"
            ErrorMessage="Priority Is Required" SetFocusOnError="True"
