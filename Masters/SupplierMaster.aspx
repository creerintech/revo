<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage_RN.master" AutoEventWireup="true" CodeFile="SupplierMaster.aspx.cs" Inherits="Masters_SupplierMaster" Title="Supplier Master" %>
    ...
    <ContentTemplate>
     ...
     Width="292px" AutoPostBack="True" ontextchanged="TxtSearch_TextChanged">
        ...
        <br />
            ...
            <asp:Label ID="lblcounttext" Text="Total No. of Suplier:- " runat="server"></asp:Label>
