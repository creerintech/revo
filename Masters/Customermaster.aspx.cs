...
public partial class Masters_Customermaster : System.Web.UI.Page
{
    ...
    DMCustomeMaster Obj_SupplierMaster = new DMCustomeMaster();
    CustomerMaster Entity_SupplierMaster = new CustomerMaster();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            lblcount.Text = db.getDb_Value("select count(*) from CustomerMaster").ToString();
        }
    }
    ...
    protected void BtnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                Entity_SupplierMaster.CustomerCode = TxtSuppCode.Text;
                Entity_SupplierMaster.CustomerName = TxtSuppName.Text.Trim();
    ...
    protected void BtnUpdate_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                Entity_SupplierMaster.CustomerId = Convert.ToInt32(ViewState["EditID"]);
            }
            Entity_SupplierMaster.CustomerCode = TxtSuppCode.Text;
            Entity_SupplierMaster.CustomerName = TxtSuppName.Text.Trim();
            Entity_SupplierMaster.TelNo = TxtTelNo.Text;
