...
public partial class Reports_StockReport : System.Web.UI.Page
{
    #region[Private variables]
        ...
        decimal Opening = 0, Consumption=0,Purchase = 0, Sales = 0, SalesReturn = 0, Inward = 0, OutwardReturn = 0, Outward = 0, TransferIN = 0, TransferOUT = 0, Damaged = 0, PurReturn = 0, Closing = 0, Amount = 0;
    #endregion
