<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="ArticlesHistoryReportOutWard.aspx.cs" Inherits="Reports_ArticlesHistoryReportOutWard" Title="Articles History OutWard Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Title" Runat="Server">
    Articles History OutWard Report    
</asp:Content>
                            ...
                            <div id="divPrint" class="ScrollableDiv_FixHeightWidth4">
                                <asp:GridView ID="GridInwordDetails" runat="server" AutoGenerateColumns="False" Width="100%"
                                    ...
                                    <Columns>
                                         ...
                                         <asp:BoundField DataField="OutwardDate" HeaderText="Out.Date">
                                            <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" Wrap="False" />
                                            <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" Wrap="False" />
                                         </asp:BoundField>
                                         <asp:BoundField DataField="OutwardQty" HeaderText="Out.Qty">
                                         ...
                                         <asp:BoundField DataField="Rate" HeaderText="Out.Rate">
                                            <HeaderStyle HorizontalAlign="Right" VerticalAlign="Middle" Wrap="False" />
                                            <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" Wrap="False" />
                                            <FooterStyle HorizontalAlign="Right" VerticalAlign="Middle" Wrap="False" Font-Bold="true"
                                                ForeColor="White" />
