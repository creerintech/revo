<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="PODetails.aspx.cs" Inherits="Reports_PODetails" Title="Purchase Order Details" %>
                      ...
                      <asp:BoundField DataField="PODate" HeaderText="Date">
                            ...
                            <asp:BoundField DataField="ItemName" HeaderText="Item" >
                                ...
                                <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" Wrap="true" />
                                 ...
                                 <asp:BoundField DataField="RemarkForPO" HeaderText="Remarl" >
                                <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" Wrap="true" />
                                <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" Wrap="true" />
                            </asp:BoundField>
