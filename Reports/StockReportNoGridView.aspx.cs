...
public partial class Reports_StockReportNoGridView : System.Web.UI.Page
{
        ...
        try
        {
            ...
            if (CheckValidation() == true)
            {
                ...
                //if (DateTime.Compare(Convert.ToDateTime(FromDate), Convert.ToDateTime(ToDate)) <= 0)
                {
                    ...
                    DsGrd = Obj_Reports.StockInHand1(FromDate, ToDate, StrCondition, out StrError);
                    ...
                    if (DsGrd.Tables.Count > 0 && DsGrd.Tables[0].Rows.Count > 0)
                    {
                        ...
                        if (!FlagPrint)
                            ImgBtnExport.Visible = true;
                        GrdReport.DataSource = DsGrd.Tables[1];
                        GrdReport.DataBind();
                        lblCount.Text = DsGrd.Tables[1].Rows.Count + " Records Found";
    ...
    protected void ImgBtnExport_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            if (DsGrd.Tables.Count > 0 && DsGrd.Tables[0].Rows.Count > 0)
            {
                ...
                GridExp.DataSource = DsGrd.Tables[1];
                GridExp.DataBind();
