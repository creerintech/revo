...
public partial class Reports_ArticlesHistoryReportOutWard: System.Web.UI.Page
{
    #region[Variables]
     ...
     public void SetInitialRow()
    {
        try
        {
            ...
            DataRow dr = null;
            dt.Columns.Add(new DataColumn("OutwardDate", typeof(string)));
            dt.Columns.Add(new DataColumn("Category", typeof(string)));
            dt.Columns.Add(new DataColumn("ItemName", typeof(string)));
            dt.Columns.Add(new DataColumn("Description", typeof(string)));
            dt.Columns.Add(new DataColumn("Unit", typeof(string)));
            dt.Columns.Add(new DataColumn("OutwardQty", typeof(decimal)));
     ...
     public void ReportGrid(string RepCondition)
    {
        try
        {
            ...
            DsGrd = Obj_ArticleHistory.GetOutwardDetailsReport(RepCondition, out StrError);
    ...
    protected void BtnShow_Click(object sender, EventArgs e)
    {
          try
        {
            ...
            {
                StrCondition = StrCondition + " and IR.ConsumptionDate between '" + Convert.ToDateTime(txtFromDate.Text).ToString("MM-dd-yyyy") + "' AND '" + Convert.ToDateTime(txtToDate.Text).ToString("MM-dd-yyyy") + "' ";
            }
            else
            {
                StrCondition = StrCondition + " AND IR.ConsumptionDate between '01-01-1975' AND '" + DateTime.Now.ToString("MM-dd-yyyy") + "' ";
            }
    ...
    protected void ImgBtnExport_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            DsGrd = Obj_ArticleHistory.GetOutwardDetailsReport(StrCondition, out StrError);
                if (DsGrd.Tables.Count > 0 && DsGrd.Tables[0].Rows.Count > 0)
                {
                    //========Call Register
                    ...
                    GridExp.DataBind();
                    obj_Comman.Export("ArticlesHistory_Outward.xls", GridExp);
                }
                else
                {
