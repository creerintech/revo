...
public partial class Reports_StockReportWithDeviation : System.Web.UI.Page
{
    #region[Private variables]
        ...
        decimal SystemOpening = 0, ActualOpening = 0, Purchase = 0, Sales = 0, SalesReturn = 0, Inward = 0, Outward = 0, TransferIN = 0, TransferOUT = 0, Damaged = 0, PurReturn = 0, Deviation = 0, SystemClosing = 0, ActualClosing = 0, SystemAmount = 0, ActualAmount = 0, OutwardReturn=0;
    #endregion
