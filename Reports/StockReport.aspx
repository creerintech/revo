<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="StockReport.aspx.cs" Inherits="Reports_StockReport" Title="Stock Report" %>
        ...
        <tr>
            <td class="Label">
                <asp:CheckBox ID="CHKNORATE" runat="server" AutoPostBack="true"
                    CssClass="CheckBox"  Text="" TabIndex="1" /></td>
            <td colspan="3">
                <asp:Label Text="SHOW RECORD WITH OUT MRP" runat="server" ID="LBLNORATE" ForeColor="Black" Font-Bold="true"> </asp:Label></td>
            <td class="Label">
          ...
          <%--   ShowFooter="True" --%>
                ...
                <div id="divPrint" class="ScrollableDiv_FixHeightWidth4">
                    <asp:GridView ID="GrdReport" runat="server" AllowPaging="false" ShowFooter="true"
                        ...
                        Width="98%" onrowdatabound="GrdReport_RowDataBound" 
