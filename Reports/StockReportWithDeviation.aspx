<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="StockReportWithDeviation.aspx.cs" Inherits="Reports_StockReportWithDeviation" Title="Stock Report With Deviation" %>
                ...
                <asp:GridView ID="GrdReport" runat="server" AllowPaging="false" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="ActualClosing" HeaderText="Actual Closing">
                           ...
                           <asp:BoundField DataField="UnitFactor" HeaderText="Unit">
                            <HeaderStyle HorizontalAlign="Right" VerticalAlign="Middle" Wrap="False" />
                            <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" Wrap="False" />
                            <FooterStyle Font-Bold="True" ForeColor="White" HorizontalAlign="Right" 
                                VerticalAlign="Middle" Wrap="True" />
                           ...
                           <asp:BoundField DataField="STOCKINHANDWITHUNITCONVERTSYSTEM" HeaderText="Actual Closing">
                            <HeaderStyle HorizontalAlign="Right" VerticalAlign="Middle" Wrap="False" />
                            <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" Wrap="False" />
                            <FooterStyle Font-Bold="True" ForeColor="White" HorizontalAlign="Right" 
                                VerticalAlign="Middle" Wrap="True" />
                           ...
                           <asp:BoundField DataField="STOCKINHANDWITHUNITCONVERTACTUAL" HeaderText="Actual Closing">
                            <HeaderStyle HorizontalAlign="Right" VerticalAlign="Middle" Wrap="False" />
                            <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" Wrap="False" />
                            <FooterStyle Font-Bold="True" ForeColor="White" HorizontalAlign="Right" 
                                VerticalAlign="Middle" Wrap="True" />
