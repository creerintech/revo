<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="MaterialReqDetailsForPurchaseManager.aspx.cs" Inherits="Reports_MaterialReqDetailsForPurchaseManager" Title="Material Indent Details" %>
 ...
 <td class="Label">
    ...
    <tr>
        <td align="right" class="Label" colspan="6">
            Net Total :
            <asp:Label ID="lblNetAmount" CssClass="Display_None" runat="server" Font-Bold="true" Text="0.00"></asp:Label>
        </td>
    </tr>
