...
public partial class Transactions_Projectscope : System.Web.UI.Page
{
    ...
    public void MakeEmptyForm()
    {
     ...
     //   CalendarExtender2.EndDate = CalendarExtender1.EndDate = DateTime.Now;
      ...
      //  TXTTEMPLATEMULTIPLY.Text = "1";
        ...
        if (HttpContext.Current.Session["TransactionSite"] != null)
           // if (!string.IsNullOrEmpty(Session["TransactionSite"].ToString()))
        {
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            drpvalvetype.DataSource = db.Displaygrid("select id, valve from  valvetype");
            drpvalvetype.DataValueField = "id";
            ...
            drpvalvesize.DataSource = db.Displaygrid("select id, valvesize from  valvesize");
            ...
            drpvalveclass.DataSource = db.Displaygrid("select id, valveclass from  valveclass");
            drpvalveclass.DataValueField = "id";
            ...
            drpvalveoperator.DataSource = db.Displaygrid("select id, valveoperator from  valveoperator");
            drpvalveoperator.DataValueField = "id";
            ...
            drpiterlock.DataSource = db.Displaygrid("select id, interlock from  interlock");
            drpiterlock.DataValueField = "id";
            drpiterlock.DataTextField = "interlock";
            ...
            drphandwheelsize.DataSource = db.Displaygrid("select id, handwheel from  handwheel");
            ...
            drplever.DataSource = db.Displaygrid("select id, lever from  lever");
            drplever.DataValueField = "id";
...

        {
...

            {
...

                {
                    ...
                    DropDownList drpvalvetype = (DropDownList)grditem.Rows[rowIndex].Cells[0].FindControl("drpvalvetype");

                    DropDownList drpvalvesize = (DropDownList)grditem.Rows[rowIndex].Cells[1].FindControl("drpvalvesize");

                    DropDownList drpvalveclass = (DropDownList)grditem.Rows[rowIndex].Cells[2].FindControl("drpvalveclass");
                    DropDownList drpvalveoperator = (DropDownList)grditem.Rows[rowIndex].Cells[3].FindControl("drpvalveoperator");
                    DropDownList drpiterlock = (DropDownList)grditem.Rows[rowIndex].Cells[4].FindControl("drpiterlock");
                    DropDownList drphandwheelsize = (DropDownList)grditem.Rows[rowIndex].Cells[5].FindControl("drphandwheelsize");
                    DropDownList drplever = (DropDownList)grditem.Rows[rowIndex].Cells[6].FindControl("drplever");
                    TextBox txtvalvetagno = (TextBox)grditem.Rows[rowIndex].Cells[7].FindControl("txtvalvetagno");
                    TextBox txtqty = (TextBox)grditem.Rows[rowIndex].Cells[8].FindControl("txtqty");
                    TextBox txtunitprice = (TextBox)grditem.Rows[rowIndex].Cells[9].FindControl("txtunitprice");
                    TextBox txttotalprice = (TextBox)grditem.Rows[rowIndex].Cells[10].FindControl("txttotalprice");



                    drpvalvetype.SelectedValue = dt.Rows[i]["Column1"].ToString();

                    drpvalvesize.SelectedValue = dt.Rows[i]["Column2"].ToString();

                    drpvalveclass.SelectedValue = dt.Rows[i]["Column3"].ToString();
                    drpvalveoperator.SelectedValue = dt.Rows[i]["Column4"].ToString();
                    drpiterlock.SelectedValue = dt.Rows[i]["Column5"].ToString();
                    drphandwheelsize.SelectedValue = dt.Rows[i]["Column6"].ToString();
                    drplever.SelectedValue = dt.Rows[i]["Column7"].ToString();
                    txtvalvetagno.Text= dt.Rows[i]["Column8"].ToString();
                    txtqty.Text= dt.Rows[i]["Column9"].ToString();
                    txtunitprice.Text= dt.Rows[i]["Column10"].ToString();
                    txttotalprice.Text= dt.Rows[i]["Column11"].ToString();
...

        {
...

            {
...

                {
                    ...
                    dtCurrentTable.Rows[i - 1]["Column1"] = drpvalvetype.SelectedValue;

                    dtCurrentTable.Rows[i - 1]["Column2"] = drpvalvesize.SelectedValue;

                    dtCurrentTable.Rows[i - 1]["Column3"] = drpvalveclass.SelectedValue;
                    dtCurrentTable.Rows[i - 1]["Column4"] = drpvalveoperator.SelectedValue;
                    dtCurrentTable.Rows[i - 1]["Column5"] = drpiterlock.SelectedValue;
                    dtCurrentTable.Rows[i - 1]["Column6"] = drphandwheelsize.SelectedValue;
                    dtCurrentTable.Rows[i - 1]["Column7"] = drplever.SelectedValue;
                    dtCurrentTable.Rows[i - 1]["Column8"] = txtvalvetagno.Text;
                    dtCurrentTable.Rows[i - 1]["Column9"] = txtqty.Text;
                    dtCurrentTable.Rows[i - 1]["Column10"] = txtunitprice.Text;
                    dtCurrentTable.Rows[i - 1]["Column11"] = txttotalprice.Text;
