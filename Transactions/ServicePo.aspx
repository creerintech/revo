<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="ServicePo.aspx.cs" Inherits="Transactions_ServicePo" %>
                                                ...
                                                <ContentTemplate>
                                                    <tr>
                                                       <%-- <td class="Label">
                                                        ...
                                                        <td align="left">
                                                         <asp:TextBox ID="txtnatureofproccessing" runat="server"  ></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
                                                                ...
                                                                </a><a href='../CrystalPrint/PrintCryRpt.aspx?ID=<%# Eval("#")%>&Flag=<%="PS2"%>&SFlag=<%# Eval("POStatus")%>&PDFFlag=<%="PDF"%>&PrintFlag=<%="NO" %>'
                                                                    target="_blank">
