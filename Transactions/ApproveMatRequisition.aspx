<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="ApproveMatRequisition.aspx.cs" Inherits="Transactions_ApproveMatRequisition" Title="Approve Material Indent" %>
...
document.getElementById('<%= dialog.ClientID %>').style.display = "none";
   ...
   <asp:Content ID="Content2" ContentPlaceHolderID="Title" Runat="Server">
       Approve &amp; Authorise Material Indent      
</asp:Content>
                     ...
                     <tr><td colspan="3"> <hr /></td></tr>
                         ...
                         <tr>
                            ...
                            <asp:TemplateField HeaderText="#" Visible="False">
                                ...
                                ImageUrl="~/Images/New Icon/ImgApprove.jpg" ToolTip="Would You Like To Approve This Indent?" OnClick="ImageApproved_Click" />

                                <asp:ImageButton ID="ImageAuthorised" runat="server" Visible="false"
                                ImageUrl="~/Images/New Icon/ImgAuthorised.jpg" ToolTip="Would You Like To Authorise This Indent?" OnClick="ImageAuthorised_Click" />
                            ...
                            <asp:BoundField DataField="RemarkIND" HeaderText="Remark">
                                     <HeaderStyle Wrap="False" />
                                     <ItemStyle Wrap="False" />
                                 </asp:BoundField>
                            <asp:BoundField DataField="RequisitionDate" HeaderText="Indent Date">
                                     <HeaderStyle Wrap="False" />
                                     <ItemStyle Wrap="False" />
                                 </asp:BoundField> 
              ...
              <td align="left" colspan="2">
                  <fieldset ID="Fieldset1" runat="server" class="FieldSet" style="width: 100%">
                      <legend ID="Legend1" runat="server" class="legend" 
                          onclick="return Legend1_onclick()">Indent Details</legend>
                            <table width="99%">
                              <tr>
                              <td>
