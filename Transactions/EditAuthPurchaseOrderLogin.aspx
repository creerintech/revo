<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="EditAuthPurchaseOrderLogin.aspx.cs" Inherits="Transactions_EditAuthPurchaseOrderLogin" %>
...
AllowPaging="false" DataKeyNames="#" onrowdatabound="GrdReqPO_RowDataBound" 
        onrowdeleting="GrdReqPO_RowDeleting" onrowcommand="GrdReqPO_RowCommand" >
<columns>
                 ...
                 <ItemTemplate>
                   <asp:ImageButton ID="ImageGridEdit" runat="server" Visible="true"
                     ...
                     <ajax:ConfirmButtonExtender ID="KKKK" runat="server" 
                       ...
                       <asp:CheckBox ID="GrdReqPO_CHK" runat="server" Height="20px" Width="20px"  />
                 </ItemTemplate>
